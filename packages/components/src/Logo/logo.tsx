...
const Logo = ({}: LogoProps) => (
  <div className="w-12 h-12 flex justify-center items-center bg-primary-600 rounded-md text-neutral-0">
    <svg className="w-9 h-9" fill="currentColor" viewBox="0 0 414 414">
